...
export const seedFacilities: SeedFacility[] = [
  ...
  { name: "University of Benin Teaching Hospital, Benin City", type: TH, stateId: "state-edo", city: "Benin City", address: "KM 10, Benin–Lagos Expressway, Ugbowo, Benin City, Edo", phone: "09133000051", source: "Official hospital website (ubth.org)" },
  ...
  { name: "Federal Medical Centre, Makurdi", type: FMC, stateId: "state-benue", city: "Makurdi", address: "No. 1 Atiku Abubakar Road, Mission Ward, Makurdi, Benue", source: "Official hospital website (fmcmakurdi.gov.ng)" },
  { name: "Federal Medical Centre, Lokoja", type: FMC, stateId: "state-kogi", city: "Lokoja", address: "No. 1 Saliu Ibrahim Way, PMB 1001, Lokoja, Kogi", phone: "08050312534", source: "Official hospital website (fmclokoja.gov.ng)" },
  ...
  { name: "Jos University Teaching Hospital, Jos", type: TH, stateId: "state-plateau", city: "Jos", phone: "08032850363", source: "Official hospital website (juth.gov.ng)" },
  { name: "Bingham University Teaching Hospital, Jos", type: TH, stateId: "state-plateau", city: "Jos" },
  { name: "University of Abuja Teaching Hospital, Gwagwalada", type: TH, stateId: "state-fct", city: "Gwagwalada", address: "Gwagwalada, PMB 228, Abuja", phone: "07040045614", source: "Official hospital website (uath.gov.ng)" },
  { name: "National Hospital, Abuja", type: SH, stateId: "state-fct", city: "Abuja", address: "Plot 132, Central Business District, PMB 425, Garki, Abuja", phone: "08097520012", source: "Official hospital website (nationalhospital.gov.ng)" },
  ...
  { name: "Abubakar Tafawa Balewa University Teaching Hospital, Bauchi", type: TH, stateId: "state-bauchi", city: "Bauchi", address: "Hospital Road, off Yandoka Road, Bauchi", phone: "08168674594", source: "Official hospital website (atbuth.gov.ng)" },
  { name: "Federal Medical Centre, Azare", type: FMC, stateId: "state-bauchi", city: "Azare", address: "No. 5 Sule Katagum Road, Azare, Bauchi", phone: "08036161249", source: "Official hospital website (fmcazare.gov.ng)" },
  { name: "University of Maiduguri Teaching Hospital, Maiduguri", type: TH, stateId: "state-borno", city: "Maiduguri", address: "Bama Road, Maiduguri, Borno", phone: "076232567", source: "Official hospital website (umth.gov.ng)" },
  ...
  { name: "Federal Medical Centre, Jalingo", type: FMC, stateId: "state-taraba", city: "Jalingo", phone: "08100197029", source: "Official hospital website (fmcjalingo.gov.ng)" },
  { name: "Federal University Wukari Teaching Hospital", type: TH, stateId: "state-taraba", city: "Wukari" },
  { name: "Federal Medical Centre, Nguru", type: FMC, stateId: "state-yobe", city: "Nguru", address: "2 Machina Road, Nguru, Yobe", phone: "08163309374", source: "Official hospital website (fmcnguru.gov.ng)" },
  ...
  { name: "Aminu Kano Teaching Hospital, Kano", type: TH, stateId: "state-kano", city: "Kano", address: "No. 1 Zaria Road, PMB 3452, Kano", phone: "08128929195", source: "Official hospital website (akth.gov.ng)" },
  ...
  { name: "Lagos University Teaching Hospital, Idi-Araba", type: TH, stateId: "state-lagos", city: "Lagos", address: "Ishaga Road, Idi-Araba, Lagos", phone: "08126843334", source: "Official hospital website (luth.gov.ng)" },
  { name: "Lagos State University Teaching Hospital, Ikeja", type: TH, stateId: "state-lagos", city: "Ikeja", address: "1-5 Oba Akinjobi Way, GRA, Ikeja, Lagos", phone: "09091481560", source: "Official hospital website (lasuth.org.ng)" },
  ...
  { name: "Obafemi Awolowo University Teaching Hospital Complex, Ile-Ife", type: TH, stateId: "state-osun", city: "Ile-Ife", address: "Ilesa Road, Ile-Ife, Osun", phone: "08152092751", source: "Official hospital website (oauthc.gov.ng)" },
  { name: "Ladoke Akintola University of Technology Teaching Hospital, Osogbo", type: TH, stateId: "state-osun", city: "Osogbo" },
  { name: "University College Hospital, Ibadan", type: TH, stateId: "state-oyo", city: "Ibadan", address: "Queen Elizabeth Road, Ibadan, Oyo", phone: "08131733447", source: "Official hospital website (uch-ibadan.org.ng)" },
